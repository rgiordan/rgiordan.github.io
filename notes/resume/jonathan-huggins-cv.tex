...
\name{Jonathan H. Huggins \vspace*{.1in}}
...
%\vspace*{-.1in}
\begin{list1}
\item[] Ph.D., Computer Science. Advisor: Tamara Broderick \hfill {2014--2018}
\item[] S.M., Computer Science. Advisor: Joshua B.~Tenenbaum \hfill {2012--2014}
\end{list1}
...
%\vspace*{-.1in}
\begin{list1}
\item[] B.A., Mathematics. Advisors: Liam Paninski and Frank D.~Wood \hfill {2008--2012}
\end{list1}


\section{\sc Professional Experience}
{\bf Google Inc.}, New York, NY USA
\begin{list1}
\item[] Summer Engineering Intern \hfill {2012}
\end{list1}
%Developed, created, and deployed a language-model based ``gibberish detector'' for
%identifying short text sequences as nonsensical.


{\bf MITRE Corp.}, Bedford, MA USA
\begin{list1}
\item[] {Technical Co-op} \hfill {2007--2009}
\end{list1}
%\vspace{-.3cm}
